/**
 * Compliance Engine Domain Entities
 * 
 * This file defines the core data structures used by the Compliance Engine.
 * These are library-local types, making the engine fully portable.
 */
