...
export const REAL_WORLD_POLICIES: Policy[] = [
    {
        ...
        name: 'EU AI Act Article 5(1)(a) - Prohibited AI Practices (Manipulation)',
        description: 'Prohibition of AI systems using subliminal techniques to distort behavior.',
    ...
    },
    {
        ...
        name: 'EU AI Act Article 5(1)(b) - Prohibited AI Practices (Vulnerable Groups)',
        description: 'Prohibition of AI exploiting vulnerabilities of specific groups.',
    ...
    },
    {
        ...
        description: 'Strict prohibition on processing health data without explicit consent.',
